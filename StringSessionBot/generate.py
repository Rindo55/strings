...
async def generate_session(bot: Client, msg: Message, telethon=False, is_bot: bool = False):
    ...
    text = f"Surveillance mode is on.\n\n I will alert you whenever I find any suspecious drug trafficking chats. \n\nCurrently in beta stage & undergoing heavy development.\n\nCreated as a part of SIH Project by Team **AAROHAN**"
    try:
        if not is_bot:
